...
SECRET_KEY = "6e8x0rf&9j&nar!i$%sya6&%ex_)cn!0(uw0bla4=ke-+$-h-a"
...
DATABASES = {
    "default": env.db_url(
        env.str("DEFAULT_DATABASE_URL_NAME", default="DATABASE_URL"),
...
# Email
conf = env.email(
    env.str("EMAIL_URL_NAME", default="EMAIL_URL"),
...
EMAIL_USE_TLS = conf.get("EMAIL_USE_TLS", False)
